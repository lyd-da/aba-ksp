        ...
        <div class="col-sm-9">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li class=""><a href="#tab_permissions" data-toggle="tab" aria-expanded="false">Permission</a>
                    </li>
                    @endcan
                </ul>
                                ...
                                <div class="box custom-box">
                                    ...
                                    <div class="box-header">
                                        <div class="user-block">
                                            ...
                                            <span class="username" style="cursor:pointer;" onclick="showFileModal({{json_encode($file)}})">{{trimText($file->name, 20)}}</span>
                                ...
                                <thead>
                                    <tr>
                                        <th colspan="3" style="font-size: 1.8rem;">
                                            Direct Permissions
                                            <button type="button" class="btn btn-primary btn-xs pull-right" data-toggle="modal" data-target="#modal-permission">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="submit" class="btn btn-danger btn-xs" onclick="return conformDel(this,event)">
